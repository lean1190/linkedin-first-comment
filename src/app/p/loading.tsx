...
export default function PlatformLoading() {
  return (
    ...
    >
      ...
      <div className="h-1 bg-neutral-700 rounded w-full my-2" />

      <section className="flex-col gap-4 sm:flex-row sm:gap-8 flex transition-all">
        <div className="w-full h-10 bg-neutral-700 rounded" />
        <div className="w-full h-10 bg-neutral-700 rounded" />
      </section>

      <section className="flex flex-col items-center">
        <div className="mx-auto mb-4 w-fit h-10 bg-neutral-700 rounded" />
        <div className="h-10 bg-neutral-700 rounded-full w-1/2" />
      </section>
    </article>
  );
}
